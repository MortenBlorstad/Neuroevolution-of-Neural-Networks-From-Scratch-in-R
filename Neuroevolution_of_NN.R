...
setwd("C:/Users/mob/OneDrive - Norwegian Hull Club/Utdanning/Neural Network - The GA Approach")
...
#Data_Balanced[,-ncol(Data_Balanced)] <- apply(Data_Balanced[,-ncol(Data_Balanced)],2, ScaleData)
...
Evolution<- training(PopSize = 250,16,1,10,7,Generations=200,TrainData)
